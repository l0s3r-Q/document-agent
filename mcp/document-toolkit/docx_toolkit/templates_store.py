...
_DOC_TYPES = {"general", "thesis", "official", "contract", "bidding", "legal", "government_report", "techdoc", "resume", "notice", "meeting_minutes", "speech", "proposal", "invitation", "news_release", "work_summary", "product_manual", "acceptance_report"}
